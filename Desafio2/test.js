...
async function main(){
    ...
    // Prueba metodo save()
    let newProduct1 = {"id":12, "name":"Protector Reforzado Transparente", "price": 1800, "src":"/resources/img/product-images/bombachita1.jpg"} // Prueba con un producto que ya posee id
    await products.save(newProduct1)
    let newProduct2 = {"name":"Protector Reforzado Negro", "price": 800, "src":"/resources/img/product-images/calzon1.jpg"} // Prueba con un producto sin id
    await products.save(newProduct2)
    // Prueba deleteById()
    console.log('Prueba de eliminacion')
    let productIdToDelete = 12
